        ...
        <div class="row">
            <div class="col-lg-5 col-sm-5">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <input type="text" name="reportedBy" class="form-control" id="reportedBy" placeholder="Reporter"
                               size="100"
                    ...
                    <div class="col-sm-8">
                        <div class="dropdown">
                            <button class="btn btn-default dropdown-toggle" type="button" id="dropdownMenu1"
                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="true" path="status"
