...
<script type="text/javascript">
    ...
    <div class="login-form__pwd_control">
        ...
        <form class="login-form" name="Login" action='${pageContext.request.contextPath}/login' method='POST'
            ...
            <input type="text" id="username" name="username" class="login-form__input login-form__input--login"
                   placeholder="soeid">
            <%-- </label>--%>

            <%-- <label class="login-form__label">Password--%>
            <input type="password" id="password" name="password" class="login-form__input login-form__input--password"
            ...
            <div class="login-form__loginsso">
                ...
                <div class="form-check">
                    ...
                    <label class="form-check-label" for="remember"> <input type="checkbox" tabindex="3" name="remember"
                                                                           id="remember"><span> Remember Me</span></label>
                </div>
        ...
        <div class="pwd_controls">
            ...
            <div class="pwd_controls__reset">
                <a href="${pageContext.request.contextPath}/forgot" id="oneResetLink" target="_blank">Forgot
                    Password</a>
            </div>
            <div class="pwd_controls__newaccess">
                <a href="${pageContext.request.contextPath}/newaccount" id="requestAccessLink" target="_blank">Request
                    New
                    Access</a>
